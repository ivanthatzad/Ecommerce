...
return array(
    ...
    'lang_ignore' => 'en', // La URL no redirigirá a "/en" en el idioma por defecto.
...
$default_lang 	= Kohana::$config->load('global.languages.default_lang');
$langs 			= Kohana::$config->load('global.languages.langs'); 
$lang_ignore 	= $default_lang;
$langs_abr		= implode('|', array_keys($langs));
if(!empty($langs_abr))
	$langs_abr .= '|' . $lang_ignore;

// Ruta para la administración 
Route::set('myadmin', '(/)myadmin(/<controller>(/<action>(/<id>)))', array('id' => '.+'))
	->defaults(array(
		'directory'	 => 'myadmin',
		'controller' => 'welcome',
		'action'     => 'index',
